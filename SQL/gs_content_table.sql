...
CREATE TABLE `gs_content_table` (
  `id` int(12) NOT NULL,
  `title` varchar(64) NOT NULL COMMENT 'サウナの名前',
  `content` varchar(256) NOT NULL COMMENT 'サウナのコメント',
  `img` varchar(256) NOT NULL COMMENT '画像のPATH',
  `date` datetime NOT NULL COMMENT '登録日',
  `update_time` datetime DEFAULT NULL COMMENT '更新日（NULL許容）'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='サウナのテーブル';
...
(35, 'サウナ名タイトル1', 'サウナコメント1', '', '2022-07-07 00:38:29', NULL),
(36, 'サウナ名タイトル２', 'サウナコメント2', '', '2022-07-07 00:38:50', NULL),
(37, 'サウナ名タイトル3', 'サウナコメント3', '', '2022-06-17 00:38:55', NULL);
